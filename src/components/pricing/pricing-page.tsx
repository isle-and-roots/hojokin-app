    ...
    <div className="p-8 max-w-6xl mx-auto">
      ...
      <div className="flex items-center justify-center gap-3 mb-10">
        ...
        <button
          ...
          className="relative inline-flex h-7 w-12 items-center rounded-full transition-colors bg-primary/20 active:scale-[0.97] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
          role="switch"
      ...
      {currentPlan !== "free" && hasCustomerId && (
        <div className="border-l-4 border-primary rounded-xl bg-card p-6 mb-8 flex items-center justify-between flex-wrap gap-4">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-primary text-primary-foreground text-sm font-medium hover:bg-primary/90 active:scale-[0.97] transition-all duration-150 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary disabled:opacity-50"
          >
            {loading === "pro" ? (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-5">
          ...
          return (
            <div
              ...
              className={`relative rounded-2xl p-6 ${
                plan.highlighted
                  ? "border-0 bg-card shadow-lg shadow-primary/10 lg:scale-105 ring-1 ring-primary/20"
                  : isCurrentPlan
            ...
            >
              {plan.highlighted && (
                <div className="absolute top-0 left-4 right-4 h-[2px] bg-gradient-to-r from-primary via-blue-400 to-primary rounded-full" />
              )}
              {plan.highlighted && (
              ...
              {isCurrentPlan && hasCustomerId ? (
                ...
                <button
                  ...
                  disabled={loading !== null}
                  className={`w-full flex items-center justify-center gap-2 py-2.5 rounded-lg text-sm font-medium transition-all duration-150 active:scale-[0.97] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary ${
                    plan.highlighted
        ...
        {/* Enterprise アンカープラン */}
        <div className="relative rounded-2xl border border-border p-6 bg-white/80 backdrop-blur-sm">
          <div className="mb-4">
  ...
  return (
    <div className="rounded-lg border border-border overflow-hidden">
      ...
      >
        {question}
        <ChevronDown
          className={`h-4 w-4 shrink-0 ml-2 text-muted-foreground transition-transform duration-200 ${open ? "rotate-180" : ""}`}
        />
      </button>
      <div
