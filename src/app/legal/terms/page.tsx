    ...
    <article className="prose prose-gray max-w-none">
      ...
      <Section title="第3条（料金および支払い）">
        <ol className="list-decimal pl-5 space-y-2">
          ...
          <li>
            決済処理はStripe, Inc.のシステムを通じて行われます。
          </li>
          <li>
            料金は税込表示です。
          </li>
      ...
      <Section title="第4条（解約・キャンセル）">
        <ol className="list-decimal pl-5 space-y-2">
          <li>
            有料プランはいつでもキャンセルすることができます。キャンセルはStripeのカスタマーポータルから行えます。
          </li>
          <li>
            キャンセル後も、現在の請求期間の終了日まではサービスをご利用いただけます。
          </li>
          <li>日割り計算による返金は行っておりません。</li>
          <li>
            デジタルサービスの性質上、一度お支払いいただいた料金の返金はお受けしておりません。
          </li>
        </ol>
      </Section>
